...
let wheelRobotPose = { x: 0.62, y: 0.42, theta: 0.18, source: "local preview /diablo/odometry" };
...
function updatePoseUi() {
  ...
  $("position-source").textContent = robotPose ? robotPose.source || "unknown" : "waiting for TF /diablo/odometry";
}
