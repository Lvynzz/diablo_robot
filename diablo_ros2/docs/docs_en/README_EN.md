...
- The Diablo controller serial port defaults to `/dev/diablo_controller`

  > You can override it without recompiling:
  > `ros2 run diablo_ctrl diablo_ctrl_node --ros-args -p controller_port:=/dev/diablo_controller`
